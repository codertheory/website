---
title: Iceteabot
tag: A general-purpose Discord bot for small servers. My first real project — the one that taught me Python and made programming click.
date: 2019-01-02
status: archived
...
features:
  - t: Moderation toolkit
    d: Role management, kicks, bans, mute timers — the basics every small server needs.
  - t: Server utilities
...
why: |
  My very first real project — and the one that turned programming from "fun hobby" into "career." discord.py was my introduction to async Python, version control, and the strange discomfort of staring at last week's code and not recognising it. I kept Iceteabot running across a few small servers for years before letting it rest.
---
